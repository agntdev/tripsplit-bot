# E1T2 — Member Management

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement organizer ability to add/remove members at any time. Members can /leavetrip. Track active status and joined/left timestamps. Requires persistent storage and permission checks.
