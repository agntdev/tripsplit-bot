# E2T1 — Expense Command and Collection Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement /expense command and 'Log expense' button. Collect payer (default author), amount, description, participants (default all), and split type. Depends on T01 and E1T1 for trip context.
