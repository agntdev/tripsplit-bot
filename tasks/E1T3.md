# E1T3 — Trip Visibility Enforcement

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement permission checks: only trip members can run trip-related commands. Validate user is member before allowing access to /balance, /expense, etc. Depends on E1T1's member tracking.
