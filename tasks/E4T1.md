# E4T1 — Payment Marking Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement /paid command and button to record payments. Collect recipient and amount. Send confirmation request to payer via DM. Depends on E3T1 for balance context.
