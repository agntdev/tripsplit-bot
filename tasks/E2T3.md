# E2T3 — Expense Summary Posting

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Post expense summaries to group chat if all members are present; otherwise send DMs. Implement visibility rules and message formatting. Depends on E2T1 and E1T3 for permissions.
