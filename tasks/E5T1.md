# E5T1 — Organizer Overview Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement /overview command to show full expense list, per-expense details, current balances, and payment history. Depends on E1T1, E2T3, E3T1, E4T2 for data.
