# E3T1 — Balance Command and View

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement /balance command to show simplified debts and net balances. Send as DM to requester with optional group summary. Depends on T01 and E2T3 for expense data.
