# E3T2 — Settlement Suggestion

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement /settle command to compute minimal transfer set using greedy largest-creditor/debtor matching. Present as suggested list of payments. Depends on E3T1's balance calculations.
