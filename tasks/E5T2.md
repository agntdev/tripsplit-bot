# E5T2 — CSV Export Functionality

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement CSV export option for organizers. Format and send trip data as CSV file. Depends on E5T1's data access.

## Skills

**Skills:** telegram-bot-basics, telegram-bot-ux, telegram-test-specs
