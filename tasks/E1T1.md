# E1T1 — Trip Creation Flow

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TSPLIT

Implement /newtrip command and interactive flow for trip creation: collect name, currency, member selection (group participants or manual input), and confirmation. Store trip in persistent storage. Depends on T01 and T02 for main menu integration.
